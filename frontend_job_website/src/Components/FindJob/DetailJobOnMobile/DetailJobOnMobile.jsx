import imageCp from "../../../Assets/imageCP.svg";
          ...
          <div>
            <div className={styles.title}>
              ...
              <span>
                ...
                distinctio quae, delectus sunt quod, voluptate voluptatibus?
                Nihil fuga rem animi voluptates hic dolores. Nobis magnam odit
                deserunt, doloremque deleniti eum commodi blanditiis quis, quia
                mollitia maiores porro tenetur, sed impedit dicta at quas in vel
                tempora! Eligendi provident modi ullam, nobis dolor velit. Aut
                quod quae voluptatibus, obcaecati inventore voluptates dolorem
                unde asperiores, suscipit sit blanditiis est aliquid, laboriosam
                esse? Eum inventore recusandae ab at porro quisquam cumque hic
                sit! Ab, debitis itaque? Expedita quas incidunt architecto
                veritatis veniam eveniet harum sit aliquam blanditiis
                doloremque, nulla ipsam dignissimos aspernatur similique fugit
                iusto quo ex aut molestias? Consectetur culpa maxime aliquid
                repellat ex cupiditate? Sed dolor modi corporis iste dicta
                excepturi laboriosam unde debitis repellendus ullam, minus
                reprehenderit quam voluptates quaerat quasi, odio velit odit non
                aliquid dolorum neque dolore blanditiis. Vitae, magni eligendi.
              </span>
            </div>
          </div>
          <div className={styles.title}>
            ...
            <span>
              ...
              maiores impedit tempora consequuntur iste provident, asperiores
              unde perferendis dignissimos quibusdam vel eveniet sit praesentium
              nihil nemo. Facere, officiis placeat? Sed, et.
            </span>
          </div>
          <div className={styles.title}>
            <h2>Contact zalo</h2>
