      ...
      <div className="lg:w-3/4 py-5 max-sm:w-full">
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="font-normal max-sm:text-lg">
              On our platform, you will not find dubious vacacies from marriage
              angencices or call centers. Only conscientious employers.
            </p>
          </div>
        </motion.div>
        <motion.div
        ...
        >
          ...
          >
            ...
            <p className="font-normal max-sm:text-lg">
              On our platform, you will not find dubious vacacies from marriage
              angencices or call centers. Only conscientious employers.More than
              2500 people found the job they dreamed of, according to a survey
              conducted in 2022
            </p>
          </motion.div>
        </motion.div>
